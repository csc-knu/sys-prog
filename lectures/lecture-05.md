...
2. $$a \cdot \varepsilon = \varepsilon \cdot a = a$$ ($$\varepsilon$$ &mdash; нейтральний 
	елемент за множенням);

3. $$a \cdot 0 = 0 \cdot a = 0$$ ($$0$$ &mdash; нульовий елемент за множенням);

4. $$a \cdot (b + c) = a \cdot b + a \cdot c$$ (ліва дистрибутивність множення відносно 
	додавання);

5. $$(a + b) \cdot c = a \cdot c + b \cdot c$$ (права дистрибутивність множення відносно 
	додавання).
