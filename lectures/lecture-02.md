...
Якщо $$M$$ &mdash; скінчений автомат, то пара $$(q, w) \in Q^\star \times \Sigma^\star$$ називається
конфігурацією автомата $$M$$. Оскільки скінчений автомат &mdash; це дискретний
...
**Зауваження.** Цей автомат неповний, він розпізнає лише цілочислові константи. 
