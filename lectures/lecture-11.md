...
- [Синтаксична діаграма](#синтаксична-діаграма)
	...
	- [Одна особливість](#одна-особливість)
...
2. Для кожного елемента слова $$\omega = \alpha_1 \alpha_2 \ldots \alpha_p$$, 
	$$\alpha_i \in (N \cup \Sigma)$$, $$i = \overline{1..p}$$ будуємо ребро синтаксичного графа 
